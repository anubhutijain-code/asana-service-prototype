...
function CalendarIcon() {
  return (
    <svg viewBox="0 0 14 14" width="14" height="14" fill="none" aria-hidden="true">
      <rect x="1.5" y="2.5" width="11" height="10" rx="1.5" stroke="#9EA0A2" strokeWidth="1.2" />
      <path d="M1.5 6h11" stroke="#9EA0A2" strokeWidth="1.2" />
      <path d="M5 1v3M9 1v3" stroke="#9EA0A2" strokeWidth="1.2" strokeLinecap="round" />
    </svg>
  );
}
...
function ChevronRightSmallIcon() {
  return (
    <svg viewBox="0 0 10 10" width="10" height="10" fill="none" aria-hidden="true">
      <path d="M3.5 2L7 5l-3.5 3" stroke="#9EA0A2" strokeWidth="1.2"
...
function TicketFieldIcon() {
  return (
    <svg viewBox="0 0 14 14" width="13" height="13" fill="none" aria-hidden="true">
      <rect x="1.5" y="1.5" width="11" height="11" rx="2" stroke="#9EA0A2" strokeWidth="1.2" />
      <path d="M4 5h6M4 7.5h6M4 10h3" stroke="#9EA0A2" strokeWidth="1.1" strokeLinecap="round" />
    </svg>
  );
}
...
function CommentOnlyPill() {
  return (
    <svg width="118" height="24" viewBox="0 0 118 24" fill="none" aria-label="Comment only" style={{ flexShrink: 0 }}>
      <rect width="118" height="24" rx="4" fill="#E8E5E4"/>
...
function Toolbar({ approvalState, assignee, onApprove, onReject, onUndo, onClose }) {
  ...
  return (
    <div
      ...
      style={{ height: 44, padding: '0 14px', borderBottom: '1px solid #EDEAE9', background: 'white', gap: 6 }}
    >
...
function InfoBanner() {
  return (
    <div
      ...
      style={{ padding: '8px 20px', background: '#F9F8F8', borderBottom: '1px solid #EDEAE9', fontSize: 12, color: '#6D6E6F', lineHeight: '18px' }}
    >
      <span style={{ flexShrink: 0, color: '#9EA0A2' }}><LockIcon /></span>
...
function FieldRow({ label, children }) {
  return (
    <div className="flex items-center" style={{ minHeight: 36, gap: 0 }}>
      <span style={{ width: 100, flexShrink: 0, fontSize: 13, color: '#6D6E6F' }}>{label}</span>
...
function AiComment({ text, time }) {
  return (
    <div className="flex items-center gap-2.5" style={{ fontSize: 13, color: '#6D6E6F', lineHeight: '20px' }}>
      <div
        className="flex items-center justify-center shrink-0"
        style={{ width: 24, height: 24, borderRadius: '50%', background: '#4573D2' }}
      >
        <LightningIcon />
      </div>
      <span>
        <span style={{ fontWeight: 600, color: '#1E1F21' }}>IT Agent</span>
        {' '}{text}
      </span>
      <span style={{ color: '#9EA0A2', whiteSpace: 'nowrap', marginLeft: 2 }}>· {time}</span>
    </div>
  );
}
    ...
    <div className="flex items-center gap-2.5" style={{ fontSize: 13, color: '#6D6E6F', lineHeight: '20px' }}>
      <div style={{ position: 'relative', width: 24, height: 24, flexShrink: 0 }}>
        ...
        <div style={{
          ...
          background: isRejection ? '#EF4444' : '#22C55E',
      ...
      <span>
        <span style={{ fontWeight: 600, color: isRejection ? '#991B1B' : '#166534' }}>{actor}</span>
...
export default function ApprovalTaskView({
  ...
  return (
    <div className="flex flex-col h-full bg-white overflow-hidden">
      ...
      >
        ...
        <div className="flex items-center gap-1" style={{ marginBottom: 14 }}>
          <button
            ...
            style={{ fontSize: 12, color: '#6D6E6F', padding: 0, maxWidth: 380 }}
          >
            {parentTaskLabel}
          </button>
        ...
        {/* Title */}
        <h2 style={{ fontSize: 22, fontWeight: 700, color: '#1E1F21', lineHeight: '30px', margin: '0 0 22px', letterSpacing: '-0.3px' }}>
          {title}
        </h2>
        ...
        <div style={{ marginBottom: 20 }}>
          ...
          <FieldRow label="Due date">
            <div className="flex items-center gap-1.5" style={{ color: '#6D6E6F' }}>
              <CalendarIcon />
          ...
          <FieldRow label="Fields">
            <div
              ...
              style={{ border: '1px solid #EDEAE9', borderRadius: 6, fontSize: 12 }}
            >
              <div
                className="flex items-center gap-1.5"
                style={{ padding: '5px 12px', background: '#FAFAF9', borderRight: '1px solid #EDEAE9', color: '#6D6E6F', whiteSpace: 'nowrap' }}
              >
                <TicketFieldIcon />
                Ticket ID (IT)
              </div>
              <span style={{ padding: '5px 12px', color: '#1E1F21', whiteSpace: 'nowrap' }}>{ticketId}</span>
            </div>
          </FieldRow>
        </div>
        ...
        {/* Description */}
        <div style={{ marginBottom: 20 }}>
          <p style={{ fontSize: 12, fontWeight: 500, color: '#6D6E6F', margin: '0 0 8px', textTransform: 'uppercase', letterSpacing: '0.4px' }}>
            Description
          </p>
          <p style={{ fontSize: 13, lineHeight: '22px', color: '#1E1F21', margin: '0 0 16px' }}>
            Action Item: <em>Please complete this approval subtask at your earliest convenience.</em>
          </p>
        </div>

        <div style={{ height: 1, background: '#EDEAE9', marginBottom: 20 }} />

        {/* Body */}
        <div style={{ fontSize: 13, lineHeight: '22px', color: '#1E1F21' }}>
          ...
          <p style={{ margin: '0 0 14px' }}>
            ...
            <span style={{ textDecoration: 'underline', cursor: 'pointer', color: '#4573D2' }}>parent</span>
            {' '}task for more context, and feel free to comment with any questions you may have.
          </p>
          <p style={{ margin: '0 0 16px' }}>
            <span style={{ textDecoration: 'underline', cursor: 'pointer', color: '#4573D2' }}>Parent Task Request</span>
          </p>
          ...
          <div
            ...
            style={{ padding: '5px 10px', background: '#F3F4F6', borderRadius: 6, fontSize: 12, color: '#1E1F21' }}
          >
            <span style={{
              display: 'inline-flex', alignItems: 'center', justifyContent: 'center',
              width: 18, height: 18, borderRadius: 4,
              background: '#6D6E6F', color: 'white',
      ...
      <div className="shrink-0" style={{ borderTop: '1px solid #EDEAE9' }}>

        {/* Tab bar */}
        <div
          className="flex items-center justify-between"
          style={{ padding: '0 20px', borderBottom: '1px solid #EDEAE9' }}
        >
          <div className="flex items-end gap-4">
            <button
              type="button"
              className="border-0 bg-transparent cursor-pointer"
              style={{ fontSize: 13, fontWeight: 600, color: '#1E1F21', padding: '10px 0 9px', borderBottom: '2px solid #1E1F21', marginBottom: -1 }}
            >
              Comments
            </button>
            <button
              type="button"
              className="border-0 bg-transparent cursor-pointer"
              style={{ fontSize: 13, color: '#6D6E6F', padding: '10px 0 9px', borderBottom: '2px solid transparent' }}
            >
              All activity
            </button>
          </div>
        ...
        >
          {comments.map(c => {
            ...
            return <p key={c.id} style={{ fontSize: 13, color: '#1E1F21', margin: 0 }}>{c.text}</p>;
          })}
          <div ref={commentsEndRef} />
        </div>

        {/* Comment input */}
        <div style={{ padding: '8px 20px 14px', borderTop: '1px solid #EDEAE9' }}>
          <div
            className="flex items-center gap-2.5"
            style={{ border: '1px solid #EDEAE9', borderRadius: 8, padding: '7px 10px 7px 12px' }}
          >
            <img
            ...
            <button
              ...
              style={{ color: '#9EA0A2', flexShrink: 0, padding: 2 }}
