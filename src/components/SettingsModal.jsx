...
function ChevronDownIcon({ up }) {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
      ...
      <path d="M13.936 5.51788C13.8082 5.36554 13.6251 5.27021 13.4269 5.25286C13.2288 5.23551 13.0319 5.29757 12.8795 5.42538L7.99902 9.52088L3.11852 5.42538C3.04331 5.36034 2.95591 5.3109 2.86142 5.27995C2.76693 5.24899 2.66722 5.23713 2.5681 5.24507C2.46898 5.253 2.37243 5.28056 2.28406 5.32615C2.1957 5.37174 2.11728 5.43445 2.05337 5.51062C1.98945 5.5868 1.94133 5.67492 1.91179 5.76987C1.88225 5.86481 1.87188 5.96469 1.8813 6.06367C1.89071 6.16266 1.91971 6.25879 1.96662 6.34647C2.01353 6.43414 2.0774 6.51162 2.15452 6.57438L7.51752 11.0744C7.6525 11.1879 7.82318 11.2501 7.99952 11.2501C8.17586 11.2501 8.34655 11.1879 8.48152 11.0744L13.8445 6.57438C13.9969 6.44654 14.0922 6.26341 14.1095 6.06529C14.1269 5.86716 14.0648 5.67026 13.937 5.51788H13.936Z" fill="#6D6E6F"/>
    </svg>
  );
}
...
function ExternalLinkIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
      <path d="M15 10.5V12C15 13.6545 13.6545 15 12 15H4C2.3455 15 1 13.6545 1 12V4C1 2.3455 2.3455 1 4 1H5.5C5.63261 1 5.75979 1.05268 5.85355 1.14645C5.94732 1.24021 6 1.36739 6 1.5C6 1.63261 5.94732 1.75979 5.85355 1.85355C5.75979 1.94732 5.63261 2 5.5 2H4C2.897 2 2 2.897 2 4V12C2 13.103 2.897 14 4 14H12C13.103 14 14 13.103 14 12V10.5C14 10.3674 14.0527 10.2402 14.1464 10.1464C14.2402 10.0527 14.3674 10 14.5 10C14.6326 10 14.7598 10.0527 14.8536 10.1464C14.9473 10.2402 15 10.3674 15 10.5ZM14.5 1H8.5C8.36739 1 8.24021 1.05268 8.14645 1.14645C8.05268 1.24021 8 1.36739 8 1.5C8 1.63261 8.05268 1.75979 8.14645 1.85355C8.24021 1.94732 8.36739 2 8.5 2H13.293L5.1465 10.1465C5.05275 10.2403 5.00008 10.3674 5.00008 10.5C5.00008 10.6326 5.05275 10.7597 5.1465 10.8535C5.24025 10.9473 5.36741 10.9999 5.5 10.9999C5.63259 10.9999 5.75975 10.9473 5.8535 10.8535L14 2.707V7.5C14 7.63261 14.0527 7.75979 14.1464 7.85355C14.2402 7.94732 14.3674 8 14.5 8C14.6326 8 14.7598 7.94732 14.8536 7.85355C14.9473 7.75979 15 7.63261 15 7.5V1.5C15 1.36739 14.9473 1.24021 14.8536 1.14645C14.7598 1.05268 14.6326 1 14.5 1Z" fill="#6D6E6F"/>
    </svg>
  );
}
    ...
    <label style={{ display: 'flex', alignItems: 'center', gap: 10, cursor: 'pointer', userSelect: 'none' }}>
      <div
        ...
        style={{
          ...
          border: checked ? 'none' : '1.5px solid #BBBFC4',
          background: checked ? '#3E7FEA' : 'white',
